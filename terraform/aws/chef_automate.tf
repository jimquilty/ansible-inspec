...
# Allow Habitat Supervisor CTL communication tcp
resource "aws_security_group_rule" "ingress_9632_tcp" {
  type                     = "ingress"
  from_port                = 9632
  to_port                  = 9632
  protocol                 = "tcp"
...
# Allow Habitat Supervisor CTL communication udp
resource "aws_security_group_rule" "ingress_allow_9632_udp" {
  type                     = "ingress"
  from_port                = 9632
  to_port                  = 9632
  protocol                 = "udp"
